...
export default class ConsoleLocaleTimestamp {
	...
	/**
	 * [Private method] Print a timestamp to the console.
	 *
	 ...
	 */
	_printTimestamp(logLevel: string, separator: string = this.#separator): void {
	...
	/**
	 * [Private method] Print a timestamp to the console. A line break is performed immediately after the timestamp.
	 *
	 * @param {string} logLevel - Grouping name of logLevel
	 */
	_printlnTimestamp(logLevel: string): void {
